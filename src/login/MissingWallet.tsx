...
const MissingWallet = ({
  hasWalletExtension,
}: MissingWalletProps): JSX.Element => {
  return (
    <div>
      <Title level={2}>
        Wallet Extension {!hasWalletExtension && "Not Installed"}
      </Title>
      <Paragraph>
        To use this application, you need to install and enable a Polkadot
        compatible browser extension.
      </Paragraph>
      {hasWalletExtension && (
        <Paragraph>Please enable website access and try again.</Paragraph>
      )}
      {!hasWalletExtension && (
        <>
          <Paragraph>
          ...
          <ol>
            ...
            <li>
              Click on "Add to Chrome" or "Add to Firefox" to install the
              extension.
            </li>
            <li>
              Once the installation is complete, click the extension icon in
              your browser toolbar to open it.
            </li>
            <li>
              Follow the extension's setup instructions and create a new account
